                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach ($berita as $item)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <a href="{{ route('berita.show', $item->id) }}" class="text-blue-500 hover:text-blue-700 font-medium mr-2">Detail</a>
                                <a href="{{ route('berita.edit', $item->id) }}" class="text-green-500 hover:text-green-700 font-medium mr-2">Edit</a>
